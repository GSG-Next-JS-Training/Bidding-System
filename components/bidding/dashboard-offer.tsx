    ...
    },
    {
        ...
        "offers": [
            ...
            },
            {
                ...
                "description": "Renovating an old bridge to meet modern safety standards.",
                "status": "Open",
        ...
        "offers": [
            {
                ...
                "description": "Developing a digital marketing campaign for a new product.",
                "status": "Open",
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-6">
                {COMPANY_BIDDINGS.map((company) => (
                    ...
                    >
                        ...
                        <Link href="/bidding/offer" className="bg-primary text-white py-2 px-4 w-full sm:w-auto text-center rounded-lg hover:bg-blue-600 transition duration-300">
